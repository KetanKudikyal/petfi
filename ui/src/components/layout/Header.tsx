            ...
            <div className='flex h-16 items-center justify-between relative'>
              ...
              <div className='absolute flex inset-y-0 items-center pr-2 right-0 sm:inset-auto sm:ml-6 sm:pr-0 sm:static'>
                ...
                <Menu as='div' className='ml-3 relative'>
                  <div>
                    <Menu.Button className='bg-gray-800 flex rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white'>
                  ...
                  >
                    <Menu.Items className='absolute bg-white mt-2 origin-top-right py-1 right-0 ring-1 ring-black ring-opacity-5 rounded-md shadow-lg w-48 focus:outline-none'>
                      <Menu.Item>
                        {({ active }) => (
                          <a
                            href='#'
